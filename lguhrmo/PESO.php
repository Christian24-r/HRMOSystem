                        ...
                        if ($filename == "") {
                            ...
                            if ($result) {
                                ...
                                if (move_uploaded_file($tempfile, $folder)) {
                                    ...
                                    //echo "<script>window.location = 'PESO.php';</script>";
                                } else {
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-8 justify-content-start">
                                            <button class="btn btn-primary rounded mb-2" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="PESO.php" method="post" enctype="multipart/form-data">
                                                    <div class="mb-3">
                                                ...
                                                <form action="uploads.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <button type="button" class="btn btn-danger me-2"
                                                            data-bs-dismiss="modal">Close</button>
                                                        <button type="submit" name="btn_img" class="btn btn-success">Submit</button>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="php/delete-peso.php?id=<?php echo $fetch['id'] ?>"
